...
export default class Graph {
    ...
    addEdge(id_node_a, id_node_b, weight = 1) {
        const nodeA = this._nodes[id_node_a];
        const nodeB = this._nodes[id_node_b];
        this._edges[id_node_a].push({origin: nodeA, destination: nodeB, weight});
        this._edges[id_node_b].push({origin: nodeB, destination: nodeA, weight});
    }
